...
func init() {
	...
	flag.StringVar(&group, "group", "QN", "Kafka consumer group definition")
	flag.StringVar(&version, "version", "2.1.3", "Kafka cluster version")
...
func (consumer *Consumer) ConsumeClaim(session sarama.ConsumerGroupSession, claim sarama.ConsumerGroupClaim) error {
	...
	for message := range claim.Messages() {
		...
		db.GetRedis().Set(ctx,"test",string(message.Value), 60 * time.Second).Err()
